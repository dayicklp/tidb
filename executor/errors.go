...
var (
	...
	ErrDynamicPrivilegeNotRegistered = terror.ClassExecutor.New(mysql.ErrDynamicPrivilegeNotRegistered, mysql.MySQLErrName[mysql.ErrDynamicPrivilegeNotRegistered])
	ErrIllegalPrivilegeLevel         = terror.ClassExecutor.New(mysql.ErrIllegalPrivilegeLevel, mysql.MySQLErrName[mysql.ErrDynamicPrivilegeNotRegistered])
)
