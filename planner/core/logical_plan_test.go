...
func (s *testPlanSuite) TestVisitInfo(c *C) {
	...
	tests := []struct {
	...
	}{
		{
			sql: "select a from t",
			ans: []visitInfo{
				{mysql.SelectPriv, "test", "t", "a", nil, "", false},
			},
		},
		{
		...
		},
		{
			...
			ans: []visitInfo{
				{mysql.UpdatePriv, "test", "t", "a", nil, "", false},
		...
		},
		{
			...
			ans: []visitInfo{
				{mysql.SelectPriv, "test", "t", "a", nil, "", false},
				{mysql.SelectPriv, "test", "t", "b", nil, "", false},
				{mysql.SelectPriv, "test", "t", "c", nil, "", false},
				{mysql.SelectPriv, "test", "t", "d", nil, "", false},
				{mysql.SelectPriv, "test", "t", "e", nil, "", false},
				{mysql.SelectPriv, "test", "t", "c_str", nil, "", false},
				{mysql.SelectPriv, "test", "t", "d_str", nil, "", false},
				{mysql.SelectPriv, "test", "t", "e_str", nil, "", false},
				{mysql.SelectPriv, "test", "t", "f", nil, "", false},
				{mysql.SelectPriv, "test", "t", "g", nil, "", false},
				{mysql.SelectPriv, "test", "t", "h", nil, "", false},
				{mysql.SelectPriv, "test", "t", "i_date", nil, "", false},
				{mysql.SelectPriv, "test", "t", "", nil, "", false},
				{mysql.UpdatePriv, "test", "t", "a", nil, "", false},
			},
		},
